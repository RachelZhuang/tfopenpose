...
if __name__ == '__main__':
    ...
    # continue
    arr = line.split(' ')
    # featMat=GetVideoFeatMat('JHMDB_video/ReCompress_Videos/pullup/Eight_wide_grip_pull-ups_pullup_u_cm_np1_ba_med_0.avi')
    featMat = GetVideoFeatMat('JHMDB_video/ReCompress_Videos/' + arr[0])
    x_train.append(featMat)
    y_train.append(arr[1][:-1])
